...
# auth
gem "omniauth-beeminder", :git => "https://github.com/beeminder/omniauth-beeminder"
gem "omniauth-google-oauth2"
gem "omniauth-pocket"
gem "omniauth-quizlet", :git => "https://github.com/kohactive/omniauth-quizlet"
gem "omniauth-trello"
